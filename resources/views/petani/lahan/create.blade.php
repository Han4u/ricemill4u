...
@section('page-title', 'Tambah Profil Lahan')
@section('breadcrumb', 'Lahan → Tambah Baru')
...
<div class="card">
    ...
    <div style="padding:24px;">
        <form action="{{ route('petani.lahan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="jenis_tanah" class="form-select-custom @error('jenis_tanah') is-invalid @enderror">
                        ...
                        <option value="tanah_liat"   {{ old('jenis_tanah')=='tanah_liat'   ? 'selected':'' }}>Tanah Liat</option>
                        <option value="tanah_pasir"  {{ old('jenis_tanah')=='tanah_pasir'  ? 'selected':'' }}>Tanah Pasir</option>
                        <option value="tanah_humus"  {{ old('jenis_tanah')=='tanah_humus'  ? 'selected':'' }}>Tanah Humus</option>
                        <option value="tanah_gambut" {{ old('jenis_tanah')=='tanah_gambut' ? 'selected':'' }}>Tanah Gambut</option>
                ...
                <div class="col-12">
                    ...
                    <textarea name="deskripsi" rows="3"
                              ...
                              placeholder="Deskripsi tambahan tentang lahan...">{{ old('deskripsi') }}</textarea>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="upload-zone" onclick="document.getElementById('foto').click()">
                        ...
                        <div style="font-size:.88rem;color:var(--text-muted);">
                            Klik untuk upload foto lahan<br>
