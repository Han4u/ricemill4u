                        ...
                        <div class="col-md-6">
                            ...
                            @if($pengiriman->bukti_kirim)
                                <div class="mt-2">
                                    ...
                                    <a href="{{ route('ricemill.pengiriman.bukti', $pengiriman) }}?t={{ $pengiriman->updated_at->timestamp }}" target="_blank">
                                        <img src="{{ route('ricemill.pengiriman.bukti', $pengiriman) }}?t={{ $pengiriman->updated_at->timestamp }}" alt="Bukti Kirim" class="img-thumbnail" style="max-height:100px; object-fit:cover;">
                                    </a>
                                </div>
                            @endif
                        </div>
